				...
				<form  class="login100-form validate-form" action="handleSendQuestion" method="POST" onSubmit="return validateQuestions()">
					...
					<div style="display: flex; align-items: center">
						...
						<div class="wrap-input100 validate-input"
							...
							<input id="theme1" name="theme1" class="input100" type="text" 
								placeholder="Question theme" style="padding: 0px; margin-top: 20px;"
								disabled />
						</div>
					</div>
					...
					<div style="display: flex; align-items: center">
						...
						<div class="wrap-input100 validate-input"
							...
							<input id="quest1" name="quest1" class="input100" type="text" 
								placeholder="Question" style="padding: 0px;"
								disabled />
					...
					<div style="display: flex; align-items: center">
						...
						<div class="wrap-input100 validate-input"
							...
							<input id="question-time" name="question-time" class="input100"
								type="text" placeholder="time in seconds" style="padding: 0px;" disabled/>
						</div>
					</div>
					...
					<section style="padding: 40px 0;">
						...
						<div style="display: flex; align-items: center" id="lab1">
							...
							<input type="checkbox" id="op-a" name="op-a" value="a" style="margin-left: 10%;">
						</div>
