...
function validateQuestions() {
	...
	for (let i = 1; i < 7; i++) {
		...
		if ((i === 1 || i === 2)
				&& (elemento.value === "" || elemento.value == null)) {
			twoQuestsError = true;
			break;
		} else if (elemento.value === "" || elemento.value == null) {
			wroteSeparated = true;
		} else if (wroteSeparated
				&& (elemento.value !== "" || elemento.value != null)) {
			errorSeparated = true;
			break;
		} else if (elemento.value !== "" && elemento.value != null) {
...
function validateNewPassword() {
	...
	if (lastpass.value.length < 6 || lastpass.value === ""
			|| lastpass.value === null) {
		lastpass.focus();
		invalid.innerHTML = "Password must be at least 6 characters long";
		return false;
	...
	if (newpass.value.length < 6 || newpass.value === ""
			|| newpass.value === null) {
		newpass.focus();
		invalid.innerHTML = "Password must be at least 6 characters long";
		return false;
	...
	if (repeatpass.value.length < 6 || repeatpass.value === ""
...
function validateNewProf() {
	...
	else if (repeatpass.value.length < 6 || repeatpass.value === ""
			|| repeatpass.value === null) {
		repeatpass.focus();
		invalid.innerHTML = "Password must be at least 6 characters long";
		return false;
	...
	else if (credential.value.length < 4 || credential.value === ""
