...
public class DataDynamicStructure {
	...
	// funcao verifica se o aluno pode aceder caso seja all podem todos sen�o so
	...
	// fun��o que diz se o aluno deve incrementar o indice da pergunta ou n�o,
	...
	// processa a resposta do aluno, primeiro guarda o id depois a informa��o
